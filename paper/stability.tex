...
\end{corollary}
\begin{proof}
Let $T$ be the local graph coordinate of a projector near $P_0$, as
constructed in Appendix~\ref{app:subspace}, with $T=0$ representing $P_0$.
Write $T_\gamma$ for the coordinate of the optimizer $P_\gamma$.
Subtracting the value at $T=0$ from the value at $T_\gamma$ gives the
leading two contributions
\begin{equation*}
